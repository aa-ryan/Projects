...
/*
 * A server program which accepts requests from the client to capitalize strings.
 * When a client connects, a new thread is started to handle it. Receiving client data,
...
public class CapitalizeServer {
	...
	public static void main(String[] args) throws Exception {
		try (var listener = new ServerSocket(59898)) {
			...
			// In Java, never create threads directly; instead, employ a "thread pool" and use and executor service to manage the threads."
			while (true) {
